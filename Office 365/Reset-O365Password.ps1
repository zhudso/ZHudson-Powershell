...
#Go through each user who's password hasn't been updated in the last 7 days to force password change at next logon.
    foreach ($user in $pwdResetUsers) {
        Write-Progress -Activity 'Processing Pwd Reset Flags & Removing Access Tokens..'
